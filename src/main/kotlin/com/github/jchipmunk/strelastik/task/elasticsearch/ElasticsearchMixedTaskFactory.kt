...
class ElasticsearchMixedTaskFactory(
        private val taskConfig: ElasticsearchMixedTask.Config,
    ...
    override fun createTask(executionRegistry: ExecutionRegistry, metricRegistry: MetricRegistry): Task {
        return ElasticsearchMixedTask(taskConfig, OPERATION, client, executionRegistry, metricRegistry)
    }
